...
export default function NotFound() {
  ...
  return (
    <section className="flex flex-col items-center py-32 text-center sm:py-48">
      ...
      <p className="mt-6 max-w-md text-muted-foreground">
        The page you were looking for does not exist, or it has moved. Everything else on this site is
